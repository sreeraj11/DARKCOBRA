...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/492098bb86cf553160543.jpg"
else:
...
USER_BOT_NO_WARN = ("\n\n                    ╲╲╭━━━━━━━╮╱╱\n                    ╲╭╯╭━╮┈╭━╮╰╮╱\n                    ╲┃┈┃┈▊┈┃┈▊┈┃╱\n                    ╲┃┈┗━┛┈┗━┛┈┃╱\n                    ╱┃┈┏━━━━━┓┈┃╲\n                    ╱┃┈┃┈┈╭━╮┃┈┃╲\n                    ╱╰╮╰━━┻━┻╯╭╯╲\n                    ╱╱╰━━━━━━━╯╲╲\n\n`Hello ! This is` **MIKE'S ** `Assistant `\n\n**Currently My Boss**\n"
    ...
    async def do_pm_permit_action(chat_id, event):
        ...
        if PM_WARNS[chat_id] == 7:
            ...
            try:
                ...
                return
        r = await event.client.send_message(event.chat_id ,USER_BOT_NO_WARN)
        PM_WARNS[chat_id] += 1
        if chat_id in PREV_REPLY_MESSAGE:
            await PREV_REPLY_MESSAGE[chat_id].delete()
        PREV_REPLY_MESSAGE[chat_id] = r
